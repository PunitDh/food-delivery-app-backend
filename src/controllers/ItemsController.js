...
const Items = {
  ...
  createOne: async ({ name, description, price, image, rating }) => {
    const data = await db.query(
      "INSERT INTO items (name, description, price, image, rating) VALUES ($1, $2, $3, $4, $5) RETURNING *;",
      [name, description, price, image, rating]
    );
    return data.rows[0];
  },
